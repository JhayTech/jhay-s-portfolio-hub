...
const HeroSection = () => {
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative gradient-bg overflow-hidden px-4">
      {/* Animated automation network background */}
      <AutomationNetwork />
      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center gap-12 relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
            <motion.a
              href="https://www.linkedin.com/in/jhaytech"
              target="_blank"
            ...
            <motion.a
              href="https://www.upwork.com/freelancers/~018279be6c4c191d69"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors"
              whileHover={{ scale: 1.05 }}
