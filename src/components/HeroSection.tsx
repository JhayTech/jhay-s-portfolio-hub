        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-heading font-bold leading-[0.95] mb-6">
            ...
            <motion.span
              ...
              style={{ textShadow: "0 0 40px hsl(175 70% 45% / 0.5), 0 0 80px hsl(175 70% 45% / 0.2)" }}
            >
              Labrador
            </motion.span>
          </h1>
          ...
          >
            <motion.a
              href="#contact"
              className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-8 py-3.5 rounded-lg font-heading font-bold text-lg click-ripple shadow-[0_0_30px_-5px_hsl(175_70%_45%_/_0.5)]"
              whileHover={{ scale: 1.05, boxShadow: "0 0 40px -5px hsl(175 70% 45% / 0.6)" }}
              whileTap={{ scale: 0.95 }}
            >
            ...
            <motion.a
              href="#experience"
              className="inline-flex items-center gap-2 border-2 border-primary/40 text-primary px-8 py-3.5 rounded-lg font-heading font-semibold text-lg"
          ...
          >
            <motion.a href="https://www.linkedin.com/in/jhaytech" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors" whileHover={{ scale: 1.05 }}>
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
              LinkedIn
            </motion.a>
            <motion.a href="https://www.upwork.com/freelancers/~018279be6c4c191d69" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors" whileHover={{ scale: 1.05 }}>
            ...
            <motion.a href="https://wa.me/639154332921" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors" whileHover={{ scale: 1.05 }}>
        ...
        >
          <div className="relative">
            <div className="w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden glow-border border-2 border-primary/30">
              <img src={profileImg} alt="Orlie Labrador" className="w-full h-full object-cover object-top" />
            </div>
            <motion.div
